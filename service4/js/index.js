...
// ÐµÐ²ÐµÑ€Ð°Ð´ 4.0, Ñ Ñ„Ð¸ÐºÑÐ¾Ð¼ Ñ‡ÐµÑ€ÐµÐ· cdn_path, Ð´Ð»Ñ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ¸ Ð½Ð° ÑÐµÑ€Ð²ÐµÑ€Ðµ
//Ð´Ð»Ñ ÐºÐ»Ð¾Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ Ð±Ð»Ð¾ÐºÐ° Ð² Ð¿Ð¾Ð¿Ð°Ð¿ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÑŽÑ‚ÑÑ ÑÐ»ÐµÐ´ÑƒÑŽÑ‰Ð¸Ðµ Ð°Ð¹Ð´Ð¸ÑˆÐ½Ð¸ÐºÐ¸
// #cloneThis - Ð´Ð»Ñ Ð´ÐµÑÐºÑ‚Ð¾Ð¿Ð°
// #cloneMobileThis - Ð´Ð»Ñ Ð¼Ð¾Ð±Ð¸Ð»ÑŒÐ½Ð¾Ð³Ð¾ (ÐµÑÐ»Ð¸ Ð½ÑƒÐ¶Ð½Ð¾)
//Ð±Ñ€ÐµÐ¹ÐºÐ¿Ð¾Ð¸Ð½Ñ‚ Ð´Ð»Ñ Ð¿ÐµÑ€ÐµÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ñ Ð¿Ð¾Ð¿Ð°Ð¿Ð° Ð¿Ñ€Ð¸ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ÑÑ‚Ð¸ Ð´ÐµÑ„Ð¾Ð»Ñ‚ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ = 1000

// Ð² ÑÐ»ÑƒÑ‡Ð°Ðµ, ÐµÑÐ»Ð¸ Ð¼Ñ‹ Ð½Ðµ ÐºÐ»Ð¾Ð½Ð¸Ñ€ÑƒÐµÐ¼ Ñ„Ð¾Ñ€Ð¼Ñƒ, Ð° Ð²ÐµÑ€ÑÑ‚Ð°ÐµÐ¼ Ð¿Ð¾Ð¿Ð°Ð¿ Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð»ÑŒÐ½Ð¾,
// Ñ‚Ð¾ Ð´ÐµÐ»Ð°Ñ‚ÑŒ ÑÑ‚Ð¾ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ Ð² ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ðµ Ñ ÐºÐ»Ð°ÑÑÐ¾Ð¼ .ever-popup-build
// false (Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€) / true (Ð½Ðµ Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€)

var popupBuild = true; // false/true


//.ever-popup-btn - ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ Ð´Ð»Ñ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚Ð¸Ñ Ð¿Ð¾Ð¿Ð°Ð¿Ð°

//Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ° ÐºÐ¾Ð´Ð°
//.check__field - ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ Ð¿Ð¾Ð»Ñ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ¸ ÐºÐ¾Ð´Ð°
//.check__btn - ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ ÐºÐ½Ð¾Ð¿ÐºÐ¸ Ð¿Ñ€Ð¾Ð²ÐµÐºÐ¸ ÐºÐ¾Ð´Ð°
//.check__result - ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ñ Ñ€ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ð¾Ð¼ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ¸ ÐºÐ¾Ð´Ð°

//Ñ‚Ð°Ð¹Ð¼ÐµÑ€
//Ð´Ð»Ñ Ð²Ñ‹Ð²Ð¾Ð´Ð° ÑÑ‡ÐµÑ‚Ñ‡Ð¸ÐºÐ° Ñ‚Ð°Ð¹Ð¼ÐµÑ€Ð° Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÑ‚ÑÑ 3 ÐºÐ¾Ð½Ñ‚ÐµÐ½ÐµÑ€Ð° (Ñ‡Ð°ÑÑ‹, Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹, ÑÐµÐºÑƒÐ½Ð´Ñ‹)
//.hours ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ Ð²Ñ‹Ð²Ð¾Ð´Ð° Ñ‡Ð°ÑÐ¾Ð²
//.minutes ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ Ð²Ñ‹Ð²Ð¾Ð´Ð° Ð¼Ð¸Ð½ÑƒÑ‚
//.seconds ÐºÐ»Ð°ÑÑ Ð´Ð»Ñ Ð²Ñ‹Ð²Ð¾Ð´Ð° ÑÐµÐºÑƒÐ½Ð´
...
if(!window.cdn_path){
    ...
    (function () {
        ...
        function initiate() {
            ...
            if (popupBuild) {
                // Ð² ÑÐ»ÑƒÑ‡Ð°Ðµ, ÐµÑÐ»Ð¸ Ð¼Ñ‹ Ð²ÐµÑ€ÑÑ‚Ð°ÐµÐ¼ Ð¿Ð¾Ð¿Ð°Ð¿ Ð² ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ðµ .ever-popup-build, Ð´Ð°Ð½Ð¾Ðµ ÑƒÑÐ»Ð¾Ð²Ð¸Ðµ Ð¿Ñ€ÑÑ‡ÐµÑ‚ ÐµÐ³Ð¾, ÐµÑÐ»Ð¸ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ Ð¿ÐµÑ€ÐµÐ¼ÐµÐ½Ð½Ð¾Ð¹ popupBuild = true
            ...
            function addPopupStyle() {
                // Ð´Ð¾Ð±Ð°Ð²Ð»ÑÐµÐ¼ ÑÑ‚Ð¸Ð»Ð¸ Ð´Ð»Ñ Ð½Ð°ÑˆÐµÐ³Ð¾ Ð¿Ð¾Ð°Ð¿Ð°
            ...
            function createOverlay() {
                // ÑÐ¾Ð·Ð´Ð°ÐµÐ¼ Ð·Ð°Ñ‚ÐµÐ¼Ð½ÐµÐ½Ð½Ñ‹Ð¹ Ñ„Ð¾Ð½ Ð´Ð»Ñ Ð¿Ð¾Ð¿Ð°Ð¿Ð° Ð¸ Ð²ÑÑ‚Ð°Ð²Ð»ÑÐµÐ¼ ÐµÐ³Ð¾ Ð² Ñ€Ð°Ð·Ð¼ÐµÑ‚ÐºÑƒ html
                ...
                // document.querySelector('.s__main').appendChild(parent);
            }

            function createModalBody(breakpoint) {
                // Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÑÐµÑ‚ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ð¼Ð¾Ðµ Ð´Ð»Ñ Ð¿Ð¾Ð¿Ð°Ð¿Ð°, ÐºÐ»Ð¾Ð½Ð¸Ñ€ÑƒÐµÑ‚ ÐµÐ³Ð¾ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ð¼Ð¾Ðµ, Ð¸ Ð¿Ð¾ÐµÑ‰Ð°ÐµÑ‚ Ð² ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€ ever-popup__body
            ...
            function modalPosition(screenHeight) {
                //Ñ€Ð°ÑÑ‡ÐµÑ‚ ÑˆÐ¸Ñ€Ð¸Ð½Ñ‹ Ð¸ Ð²Ñ‹Ð²Ð¾Ð´ ÐµÐµ Ð² html, Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚ÑÑ Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹, Ð° Ñ‚Ð°Ðº Ð¶Ðµ Ð¿Ñ€Ð¸ Ñ€ÐµÑÐ°Ð¹Ð·Ðµ
            ...
            function checkPosition(selector, container, screenHeight) {
                //Ð¿Ð¾Ð·Ð¸Ñ†Ð¸Ð¾Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð¿Ð¾Ð¿Ð°Ð¿Ð° Ð¿Ð¾ Ð²ÐµÑ€Ñ‚Ð¸ÐºÐ°Ð»Ð¸
            ...
            function showPopup() {
                //Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ Ð´Ð»Ñ Ð¿Ð¾ÐºÐ°Ð·Ð° Ð¿Ð¾Ð¿Ð°Ð¿Ð°
                var popup = document.querySelector('.ever-popup');
                popup.classList.add('show')
            }

            function hidePopup() {
                //Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ Ð´Ð»Ñ ÑÐºÑ€Ñ‹Ñ‚Ð¸Ñ Ð¿Ð¾Ð¿Ð°Ð¿Ð°
                var popup = document.querySelector('.ever-popup');
                popup.classList.remove('show')
            }

            function notHide(e) {
                //Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ Ð´Ð»Ñ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ Ð²Ñ‹Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ñ ÑÑ†ÐµÐ½Ð°Ñ€Ð¸Ñ Ð¿Ð¾ ÐºÐ»Ð¸ÐºÑƒ
                e.stopPropagation()
            }

            function checkCode(event) {
                // Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ° ÐºÐ¾Ð´Ð° Ð¿Ð¾Ð´Ð»Ð¸Ð½Ð½Ð¾ÑÑ‚Ð¸
                ...
                if (code.length === 15) {
                    msg.innerHTML = 'Ð”Ð°Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´ Ð²ÐµÑ€ÐµÐ½. Ð¡Ð¿Ð°ÑÐ¸Ð±Ð¾, Ñ‡Ñ‚Ð¾ Ð²Ñ‹Ð±Ñ€Ð°Ð»Ð¸ Ð½Ð°ÑˆÑƒ Ð¿Ñ€Ð¾Ð´ÑƒÐºÑ†Ð¸ÑŽ!';
                }
                else if (code.length === 0) {
                    msg.innerHTML = 'Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ, Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, ÐºÐ¾Ð´.';
                } else {
                    msg.innerHTML = 'Ðš ÑÐ¾Ð¶Ð°Ð»ÐµÐ½Ð¸ÑŽ, Ð´Ð°Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´ Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½! Ð’ÐµÑ€Ð¾ÑÑ‚Ð½ÐµÐµ Ð²ÑÐµÐ³Ð¾, Ð²Ñ‹ Ð¿Ñ€Ð¸Ð¾Ð±Ñ€ÐµÐ»Ð¸ Ð¿Ð¾Ð´Ð´ÐµÐ»ÑŒÐ½Ñ‹Ð¹ Ð¿Ñ€Ð¾Ð´ÑƒÐºÑ‚.';
                }
            }

            var mouseOutCount = 0;
            document.body.addEventListener('mouseleave', function (event) {
                //ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ðµ Ð½Ð° ÑƒÐ²Ð¾Ð´ Ð¼Ñ‹ÑˆÐºÐ¸ ÑÐ¾ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹. ÐµÑÐ»Ð¸ Ð¼Ñ‹ÑˆÐºÐ° ÑƒÑ…Ð¾Ð´Ð¸Ñ‚ Ð·Ð° Ð²ÐµÑ€Ñ…Ð½ÑŽÑŽ Ð³Ñ€Ð°Ð½Ð¸Ñ†Ñƒ Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð°, Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚ÑÑ Ð¿Ð¾Ð¿Ð°Ð¿
            ...
            function addPhoneBtn(breakpoint) {
                // Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ ÑÐ¸Ð½ÐµÐ¹ Ñ‚Ñ€ÑƒÐ±ÐºÐ¸ Ð´Ð»Ñ Ð²Ñ‹Ð·Ð¾Ð²Ð° Ð¿Ð¾Ð¿Ð°Ð¿Ð° Ð½Ð° Ð´ÐµÑÐºÑ‚Ð¾Ð¿Ðµ
                ...
                document.querySelector('.s__main').appendChild(phoneBtnContainer);
            ...
            function init() {
                ...
                if (h && m && s) {
                    // ÐµÑÐ»Ð¸ Ð²ÑÐµ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ (Ñ‡Ð°ÑÑ‹/Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹/ÑÐµÐºÑƒÐ½Ð´Ñ‹) ÑÑƒÑ‰ÐµÑÐ²Ñ‚ÑƒÑŽÑ‚, Ñ‚Ð¾Ð³Ð´Ð° ÑÑ€Ð°Ð±Ð°Ñ‚Ñ‹Ð²Ð°ÐµÑ‚ Ñ‚Ð°Ð¹Ð¼ÐµÑ€
                    initializeTimer();
                }
                if (desktopPopup) {
                    createOverlay();
                ...
                if (desktopPopup || mobilePopup) {
                    //ÐµÑÐ»Ð¸ Ñƒ Ð½Ð°Ñ ÐµÑÑ‚ÑŒ #cloneThis Ð¸Ð»Ð¸ #cloneMobileThis, Ñ‚Ð¾Ð³Ð´Ð° Ð²ÑÐµ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸ Ð½Ð¸Ð¶Ðµ Ð²Ñ‹Ð¿Ð¾Ð»Ð½ÑÑŽÑ‚ÑÑ
                ...
                // Ñ€Ð°Ð±Ð¾Ð°Ñ‚ÐµÑ‚ ÐµÑÐ»Ð¸ Ñƒ Ð½Ð°Ñ ÐµÑÑ‚ÑŒ ÐºÐ»Ð°ÑÑ .check__btn
                var checkBtn = document.querySelector(".check__btn");
                checkBtn && checkBtn.addEventListener('click', checkCode);
            }

            // Ð¿Ñ€Ð¸ Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚ Ñ€ÐµÐ´Ð¸ Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚ÑÑ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ init, Ð¾Ð¿Ð¸ÑÐ°Ð½Ð°Ñ Ð²Ñ‹ÑˆÐµ
            document.addEventListener('DOMContentLoaded', init);

            window.addEventListener('resize', function () {
                //Ð¿Ñ€Ð¸ Ñ€ÐµÑÐ°Ð¹Ð·Ðµ Ð¿ÐµÑ€ÐµÑÑ‡Ð¸Ñ‚Ñ‹Ð²Ð°ÐµÐ¼ Ð¿Ð¾Ð·Ð¸Ñ†Ð¸Ð¾Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð¼Ð¾Ð´Ð°Ð»ÑŒÐ½Ð¾Ð³Ð¾ Ð¾ÐºÐ½Ð°
                modalPosition(window.innerHeight);
            });
...
$(document).ready(function(){
  ...
  if (countrycode == "KZ") {
    span.text('ÐšÐ°Ð·Ð°Ñ…ÑÑ‚Ð°Ð½Ðµ');
  }
/*function showResults(obj) {
  ...
  // alert(formSum);
  var resVariants = [
    {min: 0, max: 9, result: "ÐÐµÐ·Ð½Ð°Ñ‡Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ Ð²Ñ‹Ñ€Ð°Ð¶ÐµÐ½Ð½Ñ‹Ðµ ÑÐ¸Ð¼Ð¿Ñ‚Ð¾Ð¼Ñ‹ "},
    {min: 10, max: 18, result: "Ð¡Ñ€ÐµÐ´Ð½Ðµ Ð²Ñ‹Ñ€Ð°Ð¶ÐµÐ½Ð½Ñ‹Ðµ ÑÐ¸Ð¼Ð¿Ñ‚Ð¾Ð¼Ñ‹"},
    {min: 19, max: 31, result: "Ð¢ÑÐ¶ÐµÐ»Ñ‹Ðµ ÑÐ¸Ð¼Ð¿Ñ‚Ð¾Ð¼Ñ‹"}
  ];

  var testResult = "";

  if (formQuestions==formAnswers) {
    for (i=0;i<resVariants.length;i++) {
      curVariant=resVariants[i];
      if ( (formSum>=curVariant.min) && (formSum<=curVariant.max) ) {
        testResult=curVariant.result;
        break;
      }

    }

    testResult="Ð ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚: "+testResult;

  } else {
    testResult="ÐÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ Ð¾Ñ‚Ð²ÐµÑ‚Ð¸Ñ‚ÑŒ Ð½Ð° Ð²ÑÐµ Ð²Ð¾Ð¿Ñ€Ð¾ÑÑ‹ Ñ‚ÐµÑÑ‚Ð°. ÐžÑ‚Ð²ÐµÑ‡ÐµÐ½Ð¾ "+formAnswers+" Ð¸Ð· "+formQuestions+"";
  }
  ...
  $(".tabs__question input:text[name]").each(function(){
    newArray.push($(this).val());
  });
  console.log(newArray);
  var count = 0;
  $('.question__next').on('click', function(){
    var test = $('.tabs__question-active input').is(':checked');
    console.log(test);
    if (test) {
      count++;
  ...
  $('.question__next').on('click', function(event){
    ...
    if (flaga) {
      ...
      // ÐŸÐ¾Ð²Ñ–Ð´Ð¾Ð¼Ð»ÑÑ”Ñˆ ÐºÑƒÑ€ÑÑ‚ÑƒÐ²Ð°Ñ‡ÐµÐ²Ñ–, Ñ‰Ð¾Ð± Ð²Ñ–Ð´Ð¼Ñ–Ñ‚Ð¸Ð² Ð²ÑÑ– Ñ–Ð½Ð¿ÑƒÑ‚Ð¸
  ...
  $('.question__result-btn').on('click', function(event){
    ...
    if (flaga) {
      // ÐŸÐ¾Ð²Ñ–Ð´Ð¾Ð¼Ð»ÑÑ”Ñˆ ÐºÑƒÑ€ÑÑ‚ÑƒÐ²Ð°Ñ‡ÐµÐ²Ñ–, Ñ‰Ð¾Ð± Ð²Ñ–Ð´Ð¼Ñ–Ñ‚Ð¸Ð² Ð²ÑÑ– Ñ–Ð½Ð¿ÑƒÑ‚Ð¸
      alert('Potvrdite delovanje na stranici');
    } else {
      result();
    }
  ...
  /*(function($) {
    $(function() {
      ...
      $('ul.tabs__list').on('click', 'li:not(.active)', function() {
        var test = $('.tabs__question-active .text__block').children().find('input').is(":checked");
        if (test) {
          alert(test);
        } else {
          $(this)
            .addClass('active').siblings().removeClass('active')
            .closest('div.tabs').find('div.tabs__question').removeClass('tabs__question-active').eq($(this).index()).addClass('tabs__question-active');
        }

      });
      var $tabs = $(".block3 .tabs__list").children();
  ...
  /*$('ul.content__block__list').on('click', 'li:not(.active)', function() {
    $(this)
      .addClass('active').siblings().removeClass('active')
      .closest('div.tabs').find('div.content__block__right').removeClass('block__right-active').eq($(this).index()).addClass('block__right-active');
  });
