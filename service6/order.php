        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, მადლობა შეკვეთისთვის!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">დიდი მადლობა, ინფორმაცია გადაარჩინა.</h3>
            </div>
        </div>
    </div>
</div>
EOV;
    ...
    if ($_REQUEST['payment_redirect'] and $data['code'] == 'ok' and !$data['async_save']) {
        ...
        if (!$payment_resp['error'] and $payment_resp['payment_url']) {
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        თქვენ სწორ გზაზე დგახართ!
                        <br>
                        თქვენი ამანათი მალე გამოიგზავნება. დარწმუნდით, რომ ტელეფონის სწორი ნომერი შეიყვანეთ, რომ უპასუხოთ ჩვენი მენეჯერის ზარს დეტალების დასადასტურებლად.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">შეამოწმეთ საკონტაქტო ინფორმაცია:</h3>
                <div class="list-info">
                    <ul class="list-info__list">
                        <li class="list-info__item">
                            <span class="list-info__text">ტელეფონი: </span>
                            $phone
                        </li>
                    </ul>
                </div>
                <p class="success-page__message_fail">
                    <a class="success-page__message_fail__link" href="javascript:history.back()">
                        თუ შეცდომა დაუშვით, დაბრუნდით უკან და თავიდან შეავსეთ ფორმა.
                    </a>
                </p>
                <h3 class="success-page__text" id="lowerH">
                    შეკვეთის გაფორმების დასაჩქარებლად შეიყვანეთ მიწოდების მისამართი:
                </h3>
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            <label for="" class="success-page__form__label">მისამართი</label>
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> გაგზავნა </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>ელ-ფოსტა და/ან მისამართი საჭირო!</span>" +
        "<br><br>გთხოვთ შეიყვანოთ საჭირო ინფორმაცია.",
