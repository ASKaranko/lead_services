...
function Send_Order($request, $action)
{
    ...
    $request['url'] = getBrowserUrl();
    $request['browser_locale'] = getBrowserLocale();
    $request['service'] = 'Adcombo';
...
function getParameterValue() {
    return (new URL(document.location)).searchParams.get('clickid');
}
...
document.querySelectorAll('form').forEach(
    form => {
        ...
        form.appendChild(inputElem("clickid", getParameterValue()));
