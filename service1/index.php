...
<body><div class="parallax-mirror" style="visibility: visible; z-index: -100; position: fixed; top: 0px; left: 0px; overflow: hidden; transform: translate3d(0px, 7020.81px, 0px); height: 750px; width: 1359px;"><img class="parallax-slider" src="img/5.jpg" style="transform: translate3d(-267px, -0.65px, 0px); position: absolute; height: 750px; width: 1894px; max-width: none;"></div><div class="parallax-mirror" style="visibility: visible; z-index: -100; position: fixed; top: 0px; left: 0px; overflow: hidden; transform: translate3d(0px, 5046.81px, 0px); height: 896px; width: 1359px;"><img class="parallax-slider" src="img/4.jpg" style="transform: translate3d(-214px, -0.45px, 0px); position: absolute; height: 896px; width: 1787px; max-width: none;"></div><div class="parallax-mirror" style="visibility: visible; z-index: -100; position: fixed; top: 0px; left: 0px; overflow: hidden; transform: translate3d(0px, 3178px, 0px); height: 802px; width: 1359px;"><img class="parallax-slider" src="img/3.jpg" style="transform: translate3d(-280px, -0.4px, 0px); position: absolute; height: 802px; width: 1919px; max-width: none;"></div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row option-row">
                        <div class="col-lg-6">
                            ...
                            <div class="options-line lt3"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5; animation-name: pulse;"></i> Vernichtet sämtliche Arten von Helminthen</div>
                        </div>
                        <div class="col-lg-6">
                            <div class="options-line lt4"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5; animation-name: pulse;"></i> Leitet aus dem Körper die Abfallprodukte der Parasiten heraus. </div>
    ...
    <div class="warning-block">
        <div class="container">
            <div class="warning-title mobile-hide lt11">GEMÄSS DEN LETZTEN WHO-DATEN, <br>SIND ÜBER 1 MILLIARDE MENSCHEN VON PARASITEN BEFALLEN</div>
            <div class="warning-badge wow fadeInUp mobile-hide lt12" style="visibility: visible; animation-name: fadeInUp;">90% von diesen ahnen nicht einmal, dass sie zu einem Nährstoffmileau für Helminthen wurden</div>
            <div class="warning-title red mobile-hide lt13">SIND SIE SICHER, DASS SIE NICHT UNTER DIESEN SIND? ÜBERPRÜFEN SIE SICH AUF INFEKTIONSZEICHEN!</div>
            <div class="simptoms">
                ...
                <div class="simptoms-wrapper">
                    <ul class="fadeIn wow" style="visibility: visible; animation-name: fadeIn;">
                        <li class="lt15"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Müdigkeitsgefühl</li>
                        ...
                        <li class="lt17"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Entzündungen der oberen Atemwege</li>
                        ...
                        <li class="lt19"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Alle Arten von Hautausschlägen</li>
                    ...
                    <ul class="fadeIn wow mobile-hide" style="visibility: visible; animation-name: fadeIn;">
                        ...
                        <li class="mobile-hide lt22"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Allergie (tränende Augen, Hautausschlag, Schnupfen, </li>
                        <li class="mobile-hide lt23"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Häufige Erkältungen, Angina, Nasenverstopfung</li>
                        ...
                        <li class="mobile-hide lt25"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Vergrößerung der Lymphknoten</li>
                        <li class="mobile-hide lt26"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Verdauungsstörungen: Blähungen, Verstopfung oder Durchfall </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row ways-row justify-content-center">
                <div class="col-md-3">
                    <div class="ways-card wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                        <div class="ways-card-title top-text wow fadeInUp lt28" style="visibility: visible; animation-name: fadeInUp;">Schlecht gewaschenes Obst, Gemüse und Beeren</div><img alt="icon" src="img/z1.png">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="ways-card wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                ...
                <div class="col-md-3">
                    <div class="ways-card wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                        ...
                        <div class="ways-card-title bottom-text wow lt32 animated animated" style="visibility: visible;">Öffentliche Plätze und Verkehrsmittel</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="ways-card wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
    ...
    <div class="complications parallax-window" data-image-src="img/3.jpg" data-parallax="scroll">
        <div class="container">
            <div class="h2 lt37">Parasiten, <br>die schreckliche Komplikationen auslösen:</div>
            <div class="row complications-row">
                <div class="col-lg-3">
                    <div class="complications-card wow fadeInLeft" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInLeft;">
                        ...
                        <div class="complication-description lt39">Am häufigsten (über 60%) gelangt der Zystizerkus in das Gehirn, seltener in Skelettmuskulatur und die Augen. Er lebt zwischen 5 und 30 Jahren, löst <span>Tumore aus</span> </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="complications-card wow fadeInLeft" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;">
                        ...
                        <div class="complications-title lt40">SPRINGWÜRMER</div>
                        <div class="complication-description lt41">Hausen und vermehren sich in den Verdauungsorganen und führen zur Bildung von <span>язв</span> и <span> umfangreicher Blutung </span> </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="complications-card wow fadeInLeft" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInLeft;">
                        ...
                        <div class="complication-description lt43">Beschädigen die Schleimhaut und ernähren sich von dem dabei freigesetzt werdenden Blut. Sie hinterlassen blutende Wunden, was zur Entwicklung einer<span> schweren Anämie</span> und <span>Sepsis führt</span> </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="complications-card wow fadeInLeft" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInLeft;">
                        ...
                        <div class="complication-description lt45">Es geschieht ein Absterben des Gewebes des betroffenen Organs. Außerdem werden die Blutgefäße zerstört und <span>hören auf, zu funktionieren</span> </div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="act-row row">
                <div class="col-lg-6">
                    <div class="act-card">
                        ...
                        <div>
                            ...
                            <div class="act-card-description lt48">alle möglichen Arten von Invasionen in kürzester Zeit</div>
                        </div>
                    </div>
                    <div class="act-card">
                        ...
                        <div>
                            ...
                            <div class="act-card-description lt50">Leitet aus dem Körper die Abfallprodukte der Parasiten heraus</div>
                        </div>
                    </div>
                    <div class="act-card">
                        ...
                        <div>
                            <div class="act-card-title lt51">TRÄGT BEI ZUR</div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="act-card">
                        ...
                        <div>
                            <div class="act-card-title lt55">SCHÜTZT</div>
                            <div class="act-card-description lt56">vor erneuter Ansteckung, bildet ein pathogenes Mileau im Organismus des Menschen und verstärkt die Abwehrkraft</div>
                        </div>
                    </div>
                </div>
    ...
    <div class="include parallax-window" data-image-src="img/4.jpg" data-parallax="scroll">
        <div class="container">
            <div class="h3 lt58">STARKE NATÜRLICHE REZEPTUR <span class="fadeIn wow" style="visibility: visible;">Parazitol</span> </div>
            <div class="include-row">
                <div class="include-card card-1 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div>
                        ...
                        <div class="include-card-description lt60">Aufgrund seiner einzigartigen Rezeptur bereinigt er den Organismus von Schadstoffen und schweren Metallen. Bekämpft effizient Parasiten des Magen-Darm-Traktes, indem er fremde DNS angreift. Bereinigt den Darm und die Gallenabflusswege.</div>
                    </div>
                </div>
                ...
                <div class="include-card card-3 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div>
                        ...
                        <div class="include-card-description lt64">Elemente der Schwarznuss stören den Stoffwechsel der Würmer, lösen eine Lähmung der Muskelgewebe der Parasiten aus, sowie stärken die Abwehrkraft und die Schutzfunktionen des Organismus, reinigen das Blut von den Toxinen.</div>
                    </div>
                </div>
                <div class="include-card card-4 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                    <img alt="" src="img/m4.png">
                    <div>
                        <div class="include-card-title lt65">OLIVENBAUMBLÄTTER</div>
                        <div class="include-card-description lt66">Enthält Oleuropein, welches über eine parasitentötende und pilztötende Wirkung verfügt, vermindert die oxidative Schädigung im Blut, der Leber, den Nieren und den Hirngeweben.</div>
                    </div>
                </div>
                <div class="include-card card-5 wow fadeInUp mobile-hide" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div>
                        ...
                        <div class="include-card-description lt68">In der Wurzel der Kurkuma ist Cineol, Kurkumin und Vitamin P enthalten. Cineol normalisiert die Funktion der Verdauungsorgane und dämmt die Lebenstätigkeit der Würmer ein, Kurkumin verfügt über eine parasitentötende Wirkung gegen Nematoden, Vitamin P stellt die Funktion der Organe der Hämopoese wieder her und bereinigt das Blut.</div>
                    </div>
                </div>
                <div class="include-card card-6 wow fadeInUp mobile-hide" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div>
                        ...
                        <div class="include-card-description lt70">Ist bekannt dank ihren stärksten bakterientötenden und keimtötenden Eigenschaften. Insbesondere wird sie geschätzt dank ihrer Fähigkeit, die Parasiten Bandwürmer aus dem Magendarmtrakt herauszuführen.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="benefit-row wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                <div class="chemestry-area">
                    ...
                    <div class="benefit-card card-1 lt75">Gefährliche chemische <br>Stoffe in der Rezeptur <i class="wow pulse minus" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> </div>
                    ...
                    <div class="benefit-card card-3 lt77">Trägt<br>zur Abschwächung der Abwehrkraft bei <i class="wow pulse minus" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> </div>
                    <div class="benefit-card card-4">
                        <div class="lt78">Fügt Schaden den Organen des Magendarmtrakts:<br> <span>der Leber, des Magens, der Pankreas, dem Darm, provoziert<br> Gastritis und Geschwüre.</span> </div><i class="wow pulse minus" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5; animation-name: pulse;"></i>
                    </div>
                </div>
                <div class="natural-area">
                    ...
                    <div class="benefit-card card-5 lt80">Eine vollkommen<br>natürliche Zusammensetzung <i class="wow pulse plus" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> </div>
                    <div class="benefit-card card-6 lt81">Verfügt über keine<br>Nebenwirkungen, schützt<br>innere Organe <i class="wow pulse plus" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> </div>
                    <div class="benefit-card card-7 lt82">Stärkt die Abwehrkraft <br>und Widerstandsfähigkeit<br> des Organismus gegen Infekte <i class="wow pulse plus" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> </div>
    ...
    <div class="green-title">
        <div class="container lt84"> <span>Parazitol</span> SANFT FÜR DEN MENSCHEN — HART FÜR DIE HELMINTHEN</div>
    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="doctor-description">
                        ...
                        <p class="lt86">In 95% der Fälle löst die Präsenz der Helminthen keinerlei Symptome aus, bis zu dem Zeitpunkt, an dem sie irreparable Schaden den inneren Organen zugefügt haben und die Funktion aller Systeme des Organismus gestört haben.</p>
                        <p class="lt87">Gegenwärtig ist nur das Mittel Parazitol in der Lage, den Organismus VOLLKOMEN von beliebigen Parasiten zu befreien, von denen es über 250 Arten gibt. Es erzeugt im menschlichen Organismus ein Mileau, das den Vorgang des Parasitierens an sich zerstört.</p>
                        <p class="lt88">Die Erfahrung meiner Patienten bestätigt, dass Parazitol das wirksamste und sicherste Mittel für die Vernichtung und Ausleitung ALLER arten der Invasionen ist, einschließlich von Eiern, das keine Wiederansteckung zulässt.</p>
                        <p class="lt89">Die positive Wirkung wird in 100% der Fälle erreicht“.</p><span class="lt90">PD Dr. med. Wolfgang Schmidt, Infektologe</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="add-benefit">
        <div class="container">
            <div class="h3 lt91">ZUSÄTZLICHE WIRKUNG <span class="fadeIn wow" style="visibility: visible;">Parazitol</span> </div>
            <div class="add-benefit-row">
                <div class="left-add-benefit">
                    <div class="add-benefit-card card-1 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="add-benefit-description lt92">Hilft bei der Reinigung der Organe und Gewebe, neutralisiert die Vergiftung infolge der parasitären Infektion</div><img alt="icon" src="img/b1.png">
                    </div>
                    <div class="add-benefit-card card-2 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="add-benefit-description lt93">Regeneriert Schleimhäute, bereinigt das Blut, die Lymphe, die interzellulären Flüssigkeiten</div><img alt="icon" src="img/b2.png">
                    </div>
                ...
                <div class="right-add-benefit mobile-hide">
                    <div class="add-benefit-card card-5 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="add-benefit-description lt96">Trägt zur Befreiung vom Geschwür und von Gastritis, indem es Bakterien tötet, die sie provozieren</div>
                    ...
                    <div class="add-benefit-card card-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="add-benefit-description lt97">Stellt die Funktionen der unterdrückten Organe wieder her und normalisiert sie</div>
                    ...
                    <div class="add-benefit-card card-8 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="add-benefit-description lt99">Verbessert den Zustand der Haut, der Haare und der Fingernägel</div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row option-row">
                        <div class="col-lg-6">
                            ...
                            <div class="options-line lt112"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Vernichtet sämtliche Arten von Helminthen</div>
                        </div>
                        <div class="col-lg-6">
                            <div class="options-line lt113"> <i class="wow pulse" data-wow-iteration="5" style="visibility: visible; animation-iteration-count: 5;"></i> Leitet die Produkte der Lebenstätigkeit der Parasiten heraus</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="how-we-work-card wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                        ...
                        <div class="work-description lt122">Die Fachkraft wird Kontakt mit Ihnen zur Bestätigung der Bestellung aufnehmen</div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="how-we-work-card wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
