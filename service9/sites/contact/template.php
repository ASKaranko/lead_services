...
<head><title><?php echo __('contact_1'); ?></title>
...
<table width="480" border="0" align="center" cellpadding="4" cellspacing="4" bordercolor="#F5F4F4">
    <tr>
        <td bgcolor="#F5F4F4">
            <div align="center" class="naglowki"><strong><?php echo __('contact_1'); ?></strong></div>
            <p align="center" class="text"></p><em> </em></p>
            <p align="center" class='text'><?php echo __('contact_2'); ?></p>
            <div style="margin: 0 10px; padding:10px; border-top: 1px solid gray;">
                <form name="contact_form" id="contact_form" method="post" onSubmit="return submitForm();" action="<?php echo url_site("contact_send"); ?>" style="margin: 0;">
                      <label for="cf_name" class="text" style="margin-top:15px;"><?php echo __('contact_3'); ?></label>
                      <br/>
                        <input name="cf_name" type="text" id="cf_name"/><br/> <label
                            for="cf_phone" class="text" style="margin-top:15px;"><?php echo __('contact_4'); ?></label><br/>
                    <input name="cf_phone" type="text" id="cf_phone"/><br/> <label for="cf_email" class="text"><?php echo __('contact_5'); ?></label><br/> <input name="cf_email" type="text" id="cf_email"/><br/> <label for="cf_info" class="text"><?php echo __('contact_6'); ?></label><br/> <textarea name="cf_info" id="cf_info"></textarea><br/><br/> <input
                            name="submit" type="submit" value="<?php echo __('contact_7'); ?>" id="send"/></form>
            </div>
        </td>
    </tr>
</table>
