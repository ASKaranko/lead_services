...
Class DA {
     ...
     * @return json|string
     */
    private function sendRequest($url,$post_data=null,$headers = array(), $type = null, $flag = ''){

        $page = $this->sender->send($url,$post_data, $headers, $type, $flag);
    ...
    public function createOrder($order, $action){
        ...
        $post = array_merge(
            ...
            $order);
            ;
        return $this->sendRequest($this->url.$this->urls[$action],$post, array(), 'POST', $custom_flag);
    ...
    public function updateOrder($id,$order, $action){
        ...
        return $this->sendRequest($this->url.$this->urls[$action],$post, array(), $request_type, $custom_flag);
    }
